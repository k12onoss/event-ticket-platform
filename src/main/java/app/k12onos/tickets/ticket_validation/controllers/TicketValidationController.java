package app.k12onos.tickets.ticket_validation.controllers;
...
import app.k12onos.tickets.ticket_validation.domain.responses.TicketValidationResponse;
import app.k12onos.tickets.ticket_validation.services.TicketValidationService;
...
public class TicketValidationController {
    ...
    TicketValidationResponse validateTicket(@RequestBody TicketValidationRequest validationRequest) {
        ...
        TicketValidation validation = this.ticketValidationService.validateTicket(validationRequest);
